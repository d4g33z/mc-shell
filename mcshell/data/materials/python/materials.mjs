...
export function installMCMaterialsGenerator(pythonGenerator) {
    ...
    pythonGenerator.forBlock['minecraft_picker_boats'] = function(block, generator) {
        return createPickerGenerator(block, generator, 'MATERIAL_ID');
    };

    pythonGenerator.forBlock['minecraft_picker_chest_boats'] = function(block, generator) {
        return createPickerGenerator(block, generator, 'MATERIAL_ID');
    };

    pythonGenerator.forBlock['minecraft_picker_minecarts'] = function(block, generator) {
        return createPickerGenerator(block, generator, 'MATERIAL_ID');
    };

    pythonGenerator.forBlock['minecraft_picker_passive_mobs'] = function(block, generator) {
        return createPickerGenerator(block, generator, 'MATERIAL_ID');
    };

    pythonGenerator.forBlock['minecraft_picker_hostile_mobs'] = function(block, generator) {
        return createPickerGenerator(block, generator, 'MATERIAL_ID');
    };

    pythonGenerator.forBlock['minecraft_picker_projectiles'] = function(block, generator) {
        return createPickerGenerator(block, generator, 'MATERIAL_ID');
    };

    pythonGenerator.forBlock['minecraft_picker_utility_and_special'] = function(block, generator) {
        return createPickerGenerator(block, generator, 'MATERIAL_ID');
    };
