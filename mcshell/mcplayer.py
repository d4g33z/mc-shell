...
class MCPlayer(MCClient):
    def __init__(self,name,host=MC_SERVER_HOST,port=MC_SERVER_PORT,password=None,fruit_juice_port=FJ_SERVER_PORT,cancel_event=None):
        super().__init__(host,port,password,fruit_juice_port)
        self.name = name
        self.state = {}
