...
export function installMCGenerator(pythonGenerator) {
    ...
    pythonGenerator.finish = function(code) {
        ...
        // Check if the generated code actually uses runtime_params.
        const needsRuntimeParams = code.includes('self.runtime_params');

        let constructorString;
        if (needsRuntimeParams) {
            // If needed, generate the constructor that accepts the params dictionary.
            constructorString = `
    def __init__(self, action_implementer_instance, runtime_params={}):
        self.action_implementer = action_implementer_instance
        self.runtime_params = runtime_params`;
        } else {
            // Otherwise, generate the simpler constructor.
            constructorString = `
    def __init__(self, action_implementer_instance):
        ...
        // (Imports, timestamp, and helper classes like Vec3/Matrix3 remain here)
        const finalScript = `
...
//     };
    ...
    // This is the definitive, corrected generator for a function call.
    ...
    // The logic for procedures_callreturn is exactly the same, just the final return is different.
